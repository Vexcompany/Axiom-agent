...
const GITHUB_TOOLS_LIST: ToolDefinition[] = [
  ...
  },
  {
    ...
    function: {
      name: "commit_changes",
      description:
        "Commit several file changes at once on a branch via the Git data API. Files is an array of {path, content} with full new content.",
      parameters: props(
        {
          ...ownerRepo,
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Get a pull request's details, its changed files, and comments.",
      parameters: props(
        {
          ...ownerRepo,
  ...
  },
  {
    ...
    function: {
      ...
      description:
        "Inspect GitHub Actions workflow runs for a branch or a single run id.",
      parameters: props(
        {
          ...ownerRepo,
          branch: branch("Filter runs by head branch; defaults to all recent runs."),
          runId: { type: "number", description: "Specific workflow run id to inspect." },
        },
        ["owner", "repo"]
      ),
    },
